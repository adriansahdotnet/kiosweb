...
export const productSlice = createSlice({
  ...
  initialState: {
    ...
    allUniqueCategory: [
      ...new Set(productsData.map((category) => category.category)),
    ],
    ...
    wishlist:
      typeof window !== "undefined" && localStorage.getItem("addToWishList")
  ...
  reducers: {
    ...
    specificItem: (state, { payload }) => {
      state.specificProduct = state.products.find(
    ...
    decreaseCart: (state, { payload }) => {
      const itemIndexNumber = state.addToCart.findIndex(
