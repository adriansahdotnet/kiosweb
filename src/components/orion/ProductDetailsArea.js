            ...
            <div className="col-xxl-8 col-xl-8 col-lg-8">
              <div className="product__wrapper">
                <div className="product__details-thumb w-img mb-30">
                  <img
                    src="assets/img/product/orion.png"
                    alt="product-details"
                  />
                </div>
                          ...
                          <div className="row justify-content-between">
                            <table className="table table-striped">
                              ...
                              <tbody>
                                <tr>
                                  <th scope="row">1</th>
                                  <td>Web TopUp Games - Orion Games</td>
                                  <td>Rp. 2.000.000</td>
                                </tr>
                              </tbody>
                            </table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="text-end">
                            <a
                              href="https://wa.wizard.id/4d3ffa"
                        ...
                        <tr>
                          <td>12 Bulan</td>
                          <td className="text-center">Rp 900.000</td>
                          <td className="text-end">
                            <a
                              href="https://wa.wizard.id/4d3ffa"
                              className="m-btn m-btn-5 h-10"
                      ...
                      >
                        <div className="product__overview">
                          ...
                          <ul>
                            ...
                            <li>
                              <i className="fad fa-check-circle text-primary me-2"></i>
                              Notifikasi Status Ke WhatsApp
                            </li>
                            <li>
                              <i className="fad fa-check-circle text-primary me-2"></i>
                              Notifikasi Status Ke Email
                            </li>
                            <li>
                              <i className="fad fa-check-circle text-primary me-2"></i>
                              Top Up
                          ...
                          <div>
                            ...
                            <ul>
                              ...
                              <li>
                                <i className="fad fa-check-circle text-primary me-2"></i>
                                Kelola Template WhatsApp (Data, Edit)
                              </li>
                              <li>
                                <i className="fad fa-check-circle text-primary me-2"></i>
