                  ...
                  <div className="tab-content" id="proTabContent">
                    ...
                    >
                      <div className="product__overview">
                        ...
                        <div className="product__social m-social grey-bg-2">
                          <h4 className="product__social-title">
                            Hubungi Kami
                          </h4>
                          <ul>
                            <li>
                              <a
                                ...
                                className="tw"
                              >
                                j<i className="fab fa-whatsapp"></i>
                              </a>
                            </li>
                            <li>
                              <a
                                href="https://instagram.com/kiosweb.id"
                                className="pin"
                              >
                    ...
                    >
                      <div className="product__support">
                        ...
                        <div
                          className="post-comment-form wow fadeInUp"
                          data-wow-delay=".2s"
                        >
                          <h4 className="post-comment-title mb-25">
                            Add a comment
                          </h4>
                          <form action="#">
                                ...
                                <div className="col-xl-12">
                                  <div className="post-agree d-flex align-items-center">
                                    ...
                                    <label
                                      ...
                                      htmlFor="m-agree"
                                    >
                                      Email me when this comment receives a
                                      reply
                                    </label>
                                  </div>
                                </div>
