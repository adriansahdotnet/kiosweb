          ...
          <div className="row">
            <div className="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
              <div className="page__title-wrapper text-center mb-60">
                ...
                <p>
                  Our support forums and make your support experience better.
                </p>
              </div>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="support__content">
                      ...
                      <p>
                        Oxford smashing Harry spend a penny get stuffed mate cup
                        of char It is your round.
                      </p>
                      <Link href="/contact">
                        <a className="m-btn m-btn-border m-btn-border-3">
                          Submit Ticket
                        </a>
                      </Link>
                    </div>
            ...
            <div className="col-xxl-12">
              <div className="support__thumb text-center mt-40">
                ...
                <p>
                  ...
                  <a href="mailto:halo@kiosweb.id">cs@kiosweb.id</a>{" "}
                </p>
              </div>
            </div>
          </div>
