                     ...
                     <div className="sign__wrapper white-bg">
                        <div className="sign__header mb-35">
                           <div onClick={handleGoogleSignIn} className="sign__in text-center">
                              <a href="#" className="sign__social g-plus text-start mb-15"><i className="fab fa-google-plus-g"></i>Masuk dengan Google</a>
                              <p> <span>........</span> atau, <Link href="/sign-up"><a >daftar</a></Link> menggunakan email<span> ........</span> </p>
                           </div>
                        </div>
                           ...
                           <form onSubmit={handleSubmit(onSubmit)}>
                              ...
                              <div className="sign__action d-sm-flex justify-content-between mb-30">
                                 <div className="sign__agree d-flex align-items-center">
                                    ...
                                    <label className="m-check-label" htmlFor="m-agree">Ingat saya
                                    </label>
                                 </div>
                              ...
                              <button type='submit' className="m-btn m-btn-4 w-100"> <span></span> Masuk</button>
                              <div className="sign__new text-center mt-20">
                                 <p>Baru di Kios Web? <Link href="/sign-up"><a >Daftar sekarang</a></Link></p>
                              </div>
                           </form>
                        </div>
                     </div>
