               ...
               <div className="row">
                  <div className="col-xxl-6 offset-xxl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                     <div className="section__title-wrapper text-center mb-45">
                        ...
                        <p className="wow fadeInUp" data-wow-delay=".5s">Thousands of Kios Web Brands have made the swich.Text marketing with the customer in mind!</p>
                     </div>
                  </div>
               </div>
               <div className="row">
                  <div className="col-xxl-6 offset-xxl-3">
                     <div className="cta__content text-center wow fadeInUp" data-wow-delay=".7s">
                        <Link href="/product"><a  className="m-btn m-btn-border-2 cta__btn active"> <span></span> Start 14 Day Free Trial</a></Link>
                        <Link href="/product"><a  className="m-btn m-btn-border-2 cta__btn"> <span></span> Claim Free Demo</a></Link>
